package dev.pavatus.lib.register.datapack;
...
public abstract class SimpleDatapackRegistry<T extends Identifiable> extends DatapackRegistry<T>
    ...
    public void readFromServer(PacketByteBuf buf) {
        ...
        SakitusMod.LOGGER.info("Read {} {} from server", size, this.name);
    }
    ...
    public void reload(ResourceManager manager) {
        ...
        for (Identifier id : manager
            ...
            try (InputStream stream = manager.getResource(id).get().getInputStream()) {
                ...
                SakitusMod.LOGGER.info("Loaded datapack {} {}", this.name, created.id().toString());
            } catch (Exception e) {
                SakitusMod.LOGGER.error("Error occurred while loading resource json {}", id.toString(), e);
            }
        }
